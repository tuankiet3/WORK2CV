...
export default function NewLogPage() {
  ...
  const [impactLevel, setImpactLevel] = useState<ImpactLevel>("implemented");
  ...
  const handleCreateTagSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Add to available tags list and auto-select
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Successful creation, redirect to work logs index
      router.push("/logs");
    } catch (err: unknown) {
